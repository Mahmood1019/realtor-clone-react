...
import Image from '../images/key-image';
    ...
    <section>
      ...
      <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
        <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
          <img src={Image} alt="key" className='w-full rounded-2xl' />
        </div>
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          ...
          hover:bg-blue-700 uppercase rounded transition duration-150 ease-in-out
            text-sm shadow-md hover:shadow-lg active:bg-blue-800' type="submit">Send reset email</button>
